...
log_file = open(r'D:/Libraries/Documents/projects/Abaqus/paper_reproduction/experiment4/geometry_debug_v14.txt', 'w')
...
log("Upper face found: {}".format(upper_face))
...
log("Lower right face found: {}".format(lr_face))
...
# SAVE
# =============================================================================
mdb.saveAs(r'D:/Libraries/Documents/projects/Abaqus/paper_reproduction/experiment4/Experiment4_TO_Specimen_v14.cae')
