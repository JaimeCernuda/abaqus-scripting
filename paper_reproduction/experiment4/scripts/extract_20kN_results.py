...
odb = openOdb(os.path.join(PROJECT_DIR, 'Job_20kN.odb'))
...
with open('results_20kN.txt', 'w') as f:
    f.write('Job_20kN Results (20 kN vertical load)\n')
    f.write('=' * 50 + '\n')
    ...
    if max_mises > 980:
        ...
        f.write('\nLoad is within elastic range (yield = 980 MPa)\n')
