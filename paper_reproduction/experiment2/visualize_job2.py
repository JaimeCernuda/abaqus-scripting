# visualize_job2.py - EXPERIMENT 2
#
# Opens Job 2 ODB and saves von Mises stress contour screenshot
#
# Run with: abaqus cae noGUI=paper_reproduction/scripts/experiment2/visualize_job2.py
...
print("\n" + "=" * 70)
print("EXPERIMENT 2 - VISUALIZE JOB 2 RESULTS")
print("=" * 70)

# Open ODB
odb_path = OUTPUT_DIR + 'Exp2_Job2_Horizontal.odb'
print(f"\nOpening: {odb_path}")
...
# Save screenshot
img_path = OUTPUT_DIR + 'screenshots/Job2_VonMises.png'
...
vp.view.fitView()
img_path2 = OUTPUT_DIR + 'screenshots/Job2_VonMises_Front.png'
...
print("\n" + "=" * 70)
print("JOB 2 VISUALIZATION COMPLETE")
print("=" * 70)
